...
function repetirMensaje() {
    ...
    do{
            ...
            console.log("estoy aprendieno JavaScript");
            contador++;
...
function detenerEnSeis() {
    for (let i = 1; i <= 10; i++) {
        if (i === 6) {
            break; // Detén el bucle cuando i es 6
        }
        console.log(i); // Imprime los números hasta que i sea 6
    }
...
function saltarCinco() {
    for (let i = 0; i <= 10; i++) {
        if (i ==5) {
            continue; // Se salta la iteración cuando i es 5
        }
